...
mod tests {
    use super::*;
    use crate::db::{Manifest, ManifestEntry, TombstoneEntry};
    ...
    #[test]
    fn creates_dir_missing_locally() {
        let local = Manifest::default();
        let remote = Manifest {
            resources: vec![ManifestEntry {
    ...
    #[test]
    fn no_action_when_local_is_newer() {
    ...
    #[test]
    fn remote_tombstone_newer_than_local_live_deletes_locally() {
    ...
    #[test]
    fn remote_tombstone_older_than_local_live_is_ignored() {
